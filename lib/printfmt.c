...
//get a reverse of a number
static unsigned long long 
getreversenum(unsigned long long num, int *numlenptr,unsigned base)
{
	int numlen = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
	...
	if(padc == '-'){
		...
		unsigned long long reversenum = 0;
		int numlen = 0;
		reversenum = getreversenum(num,&numlen,base);
		width -= numlen;
		for( ; numlen>=0;--numlen,reversenum /= base){
